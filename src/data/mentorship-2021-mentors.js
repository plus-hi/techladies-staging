    ...
    mentors: [
      {
        ...
        description: (
          <>
            Amanda is a software engineer who transitioned from the finance
            industry over 4 years ago after joining a coding bootcamp. She is
            familiar with the struggles that come with career switching and is
            keen to share what she has learnt. She was a mentor in a previous
            Techladies bootcamp and is now based in Berlin. She spends most of
            her time building applications on AWS and less of her time
            traveling.
          </>
        ),
      },
      ...
      },
      {
        ...
        description: (
          <>
            Vanessa is a front-end developer in a multi-national software
            consulting company. She spends her free time learning Japanese
            language and enjoying Japanese entertainment.
          </>
        ),
      },
      {
        ...
        description: (
          <>
            Currently a MVP Studio Engineer, NUS Enterprise with 10 years of
            experience in payments as firmware developer, 5 years in various
            startups as Tech Lead.
          </>
        ),
      },
      {
        ...
        description: (
          <>
            Biju Joseph Jacob is a passionate techie who works as a Senior
            Engineering Manager at Grab. He leads a few teams within the
            Engineering Platform division, focused on building large scale
            services and infrastructure that is used across all lines of
            businesses offered by the company (transport, food, payments,
            insurance, etc). During his free time, Biju relishes experimenting
            with new technology and frequently works on various small-scale
    ...
    mentors: [
      {
        ...
        description: (
          <>
            Esther is an experience designer from Singapore, building a more
            caring and inclusive world through the lens of design. She believes
            that designing for equity is the only viable way forward in our
            increasingly complex world. With a varied background in social
            design, systems engineering and analytics, her design philosophy is
            grounded in humility, introspection and trust-building, and fuelled
            by a strategic understanding of the systems around us. Throughout
            her years in designing both digital and physical experiences, she
            takes a collaborative and participatory approach, while building the
            capacity of communities and organizations towards sustainable
            impact.
          </>
        ),
      },
      ...
      },
      {
        ...
        description: (
          <>
            Julie is a UX Researcher passionate about how to study users and
            develop amazing products, both in the digital and physical world.
            Her Specialties: UX Management, UX Research, Usability research,
  ...
  product: {
    ...
    mentors: [
      ...
      },
      {
        ...
        description: (
          <>
            Geraldine is currently a product manager working at Ninja Van. She
            has transited from an operations role to a product role. Her hobbies
            include reading, hiking and playing the violin.
          </>
        ),
      },
      {
        ...
        description: (
          <>
            Shweta is currently leading the food and mart consumer experience
            product teams at Grab. She started her career in consumer banking
            and made the switch into tech product management ~5 years ago. She
    ...
    mentors: [
      {
        ...
        description: (
          <>
            ...
            Analytics and Intelligent System at NUS Institute of Systems Science
      ...
      },
      {
        ...
        description: (
          <>
            Diya is an experienced Data Science and Analytics professional, with
            a keen interest in problem solving and integrating business needs
            with technology. She has worked with different programming languages
            and reporting tools, across verticals. She loves to read, travel and
            constantly learn. Passionate about increasing Women representation
            in STEM she is a strong advocate of D&I initiatives.
          </>
        ),
      },
      {
