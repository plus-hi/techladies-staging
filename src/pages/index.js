        ...
        <div className="container py-6">
          <div className="row gy-6">
            ...
            <div className="col-lg-5 col-md-6 order-md-first">
              <h1 className="mb-4">Start and grow your career in tech</h1>
              <p className="mb-4 text-body large-line-height">
                TechLadies is a community in Asia that supports women with the
                network, education, and mentorship for their careers in
                technical roles.
              </p>
              <div className="mb-3">
                {/* <label
          ...
          <div className="row gy-5">
            <div className="col-md-4">
              ...
              <p className="text-body">
                Community members in Asia interested in growing or starting
            ...
            <div className="col-md-4">
              ...
              <p className="text-body">
                Ladies successfully switched careers into technical roles
            ...
            <div className="row gy-5">
              <div className="col-md-6 d-flex flex-column align-items-start justify-content-center">
                ...
                <p className="text-body mb-4">
                  ...
                  technical skills, or levelling up your career, TechLadies is
                  for you!
                </p>
